...
class Game:
    ...
    def __init__(self, chat_id, game_message_id, topic_message_id, initiator, topic):
    ...
    def get_to_estimate_button(self):
        return {
            ...
            "text": "👍 To estimate",
            "callback_data": "discussion-vote-click-{}-{}".format(self.game_message_id, DiscussionVote.VOTE_TO_ESTIMATE),
        }
    ...
    def get_need_discuss_button(self):
        return {
            "type": "InlineKeyboardButton",
            "text": "⁉️ Discuss",
            "callback_data": "discussion-vote-click-{}-{}".format(self.game_message_id, DiscussionVote.VOTE_NEED_DISCUSS),
        }
    ...
    def get_estimation_vote_button(self, vote):
        return {
            "type": "InlineKeyboardButton",
            "text": vote,
            "callback_data": "estimation-vote-click-{}-{}".format(self.game_message_id, vote),
        }
    ...
    def get_start_estimation_button(self):
        return {
            ...
            "callback_data": "{}-click-{}".format(self.OPERATION_START_ESTIMATION, self.game_message_id),
        }
    ...
    def get_clear_votes_button(self):
        return {
            "type": "InlineKeyboardButton",
            "text": "Clear votes",
            "callback_data": "{}-click-{}".format(self.OPERATION_CLEAR_VOTES, self.game_message_id),
        }
    ...
    def get_re_vote_button(self):
        return {
            "type": "InlineKeyboardButton",
            "text": "Re-estimate",
            "callback_data": "{}-click-{}".format(self.OPERATION_RE_ESTIMATE, self.game_message_id),
        }
    ...
    def get_end_game_button(self):
        return {
            "type": "InlineKeyboardButton",
            "text": "End estimation",
            "callback_data": "{}-click-{}".format(self.OPERATION_END_ESTIMATION, self.game_message_id),
        }
    ...
    @classmethod
    def from_dict(cls, chat_id, game_message_id, topic_message_id, dict):
        result = cls(chat_id, game_message_id, topic_message_id, dict["initiator"], dict["topic"])
